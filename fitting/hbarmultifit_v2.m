function [Zfit, data] = hbarmultifit_v2(f, z, config, cnames, curves, params, varargin)
    ...
    if any(strcmp('Weights', varargin))
        options = {'MaxIter', 20, 'FunValCheck', 'off', 'DerivStep', 0.001};
    else
        options = {'MaxIter', 20, 'FunValCheck', 'off', ... 
                   'DerivStep', 0.1, 'RobustWgtFun', 'bisquare'};
    end
    ...
    [sfinal, R,J,C,E] = nlinmatrixfit(F, M, model, sinitial, options, varargin{:});
